                    ...
                    <div class="table-responsive">
                     ...
                     $sql = $koneksi->query("SELECT * FROM produk");
                            ...
                            <tr>
                                ...
                                <td><a type='button' href='?page=edit-barang&ProdukID=<?= $data['ProdukID']; ?>' class="badge badge-primary p-2">Edit</a> <a type='button' href='?page=hapus-barang&ProdukID=<?= $data['ProdukID']; ?>' class="badge badge-primary p-2">Delete</a></td>
                                <td>
